...
def get_node_predictions(
    ...
    return evaluate_node_degradations(db, market_id=market)
...
def propose_assurance_dispatch(
    ...
    predictions = evaluate_node_degradations(db, market_id=node.market_id or market)
    ...
    rec = create_or_get_recommendation(
        ...
        market_id=node.market_id or market,
        action_payload={
